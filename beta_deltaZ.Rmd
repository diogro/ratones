...
The direction of divergence $\delta z$ behaves the same way as $\Delta z$, and when the selection gadient is related to overall size, is also a better predictor of the actual direction of selection than the estimated $\beta$.
