...
save_plot("~/Dropbox/labbio/Shared Lab/Ratones_shared/figure3_SIversion.png", figure_3, ncol = 2, nrow = 2, base_aspect_ratio = 1.3, base_height = 4)
save_plot("~/Dropbox/labbio/Shared Lab/Ratones_shared/figure4_SIversion.png", figure_4, ncol = 2, nrow = 2, base_aspect_ratio = 1.3, base_height = 4)
